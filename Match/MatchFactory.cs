...
namespace Contest.Business
{
    ...
    public class MatchFactory : IMatchFactory
    {
        ...
        public IMatch Create(IGameStep gameStep, ITeam team1, ITeam team2, IMatchSetting setting)
        {
            ...
            if (gameStep == null) throw new ArgumentNullException("gameStep");
            if (team1.Id == team2.Id) throw new ArgumentException("Les deux équipes d'un même match ne peuvent pas être identique.");
