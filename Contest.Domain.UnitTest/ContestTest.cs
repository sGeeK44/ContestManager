...
namespace Contest.Business.UnitTest
{
    ...
    public class ContestTest
    {
        ...
        public void Init()
        {
            ...
            customComposer.AddType(typeof(TeamPhaseRelationshipRepository));
            customComposer.AddType(typeof(TeamGameStepRelationshipRepository));
            customComposer.AddType(typeof(EliminationStepRepositoryMock));
            customComposer.AddType(typeof(QualificationStepRepositoryMock));
            customComposer.AddType(typeof(PhaseRepositoryMock));
            customComposer.AddType(typeof(QualificationStepSettingRepositoryMock));
            customComposer.AddType(typeof(EliminationStepSettingRepositoryMock));
            customComposer.AddType(typeof(PhysicalSettingRepositoryMock));
            customComposer.AddType(typeof(TeamRepositoryMock));
            customComposer.AddType(typeof(FieldRepositoryMock));
            customComposer.AddType(typeof(GameStepRepositoryMock));
            customComposer.AddType(typeof(GameSettingRepositoryMock));
            customComposer.AddType(typeof(MatchSettingRepositoryMock));
        ...
        private static IContest CreatePlannedContest(Mock<IPhysicalSetting> physicalSetting = null, Mock<IGameSetting> gameSetting = null)
        {
            ...
            return Domain.Games.Contest.Create(DateTime.Now, physicalSetting.Object, gameSetting.Object);
        }
