...
namespace Contest.Domain.Matchs
{
    ...
    /// </summary>
    public class InProgressMatchState : InternalMatchState
    {
        #region Constructors
        ...
        /// </summary>
        public override bool IsBeginning => true;
        ...
        /// </summary>
        public override MatchState State => MatchState.InProgress;
        ...
        public override bool SetResult(ushort teamScore1, ushort teamScore2)
        {
            ...
            if (!CurrentMatch.Setting.IsValidToFinishedMatch(teamScore1, teamScore2, out var message))
